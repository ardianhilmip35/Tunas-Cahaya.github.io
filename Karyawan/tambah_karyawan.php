<?php
	...
	if(!isset($_SESSION['id_karyawan'])) {
        ...
        if (isset($_POST['register'])) {
            ...
            $query = "INSERT INTO tb_karyawan VALUES ('', '$userName', '$userIDJabatan', '$userMail','$userPass', '$userTelp', '$userAlamat')";
						...
						<div class="row" style="width: 50%; margin-left: 20%; margin-top: 3%;">
							<div class="col-sm-6" style="padding-bottom:40px;">
								<div class="card-style" style="background-color: #1E3163; width:310%; height: 100%;">
									<div class="card-body">
									<h5 style="color: #fff;"><b>Tambah Data Karyawan</b></h5>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-sm-6" style="padding-bottom:40px;">
								<div class="card-style" style="background-color: #B2DFFB; height: 515px; width:310%">
									<div class="card-body">										
                                        ...
                                        <p>
                                            <label for="jabatan" style="background-color: #1E3163; color: #fff; width: 160px; height: 30px; text-align: center; margin-left: 50px; margin-top: 10px;"><b>JABATAN</b></label>
                                        ...
                                        <p>
                                            ...
                                            <input type="password" name="txt_password" placeholder="Password" style="margin-left: 50px; width: 70%;" required/>
                                        </p>
                                        <p>
                                            ...
                                            <input type="number" name="txt_telp" placeholder="No. Telp" style="margin-left: 50px; width: 70%;" required/>
                                        </p>
                                        <p>
                                        ...
                                        <a href="#" style="text-decoration: none; color: black;">
                                            <button type="submit" value="" class="btn btn-primary" style="margin-left: 73%; background-color: #1E3163; width: 10%;  color: white;" name="register">
                                            <b>Tambah</b></button>
                                        </a>
