	...
	<body style="background-color:#ffffff">
		...
		<div id="wrapper">
                    ...
                    <div class="row" style="width: 50%; margin-left: 20%; margin-top: 3%;">
                        <div class="col-sm-6" style="padding-bottom:40px;">
                            <div class="card-style" style="background-color: #1E3163; width:310%; height: 100%;">
                                <div class="card-body">
                                <h5 style="color: #fff;"><b>Data Karyawan</b></h5>
                                </div>
                            </div>
                        </div>
                    </div>
          ...
          <section class="content" style="margin-top: -2%">
            <div class="button">
                  <a href="tambah_karyawan.php" style="text-decoration: none;">
                      <button type="submit" value="" class="btn btn-primary" style="margin-left: 5%; margin-top: -14%; background-color: #B2DFFB; width: 10%; color: black;">
                      <b>Tambah</b></button>
                  </a>
                  <a href="cetak.php" target="_blank" style="text-decoration: none;">
                    <button type="button" value="" class="btn btn-primary" style="margin-left: 1%; margin-top: -14%; background-color: #B2DFFB; width: 10%; color: black;">
                    <b>Cetak</b></button>
                  </a>
            </div>
            <div class="container-fluid">
                  ...
                  <div class="card" style="margin-left: 5%; margin-top: -5%">
                    ...
                    <!-- <div class="card-body" > -->
                      <table class="table table-bordered" width="100" cellspacing="0" border="1">
                            ...
                            include '../koneksi.php';
                            $batas = 5;
                            $banyakData = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tb_karyawan"));
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['nama']?></td>
                                  <?php 
                                    $jabatan  = mysqli_query($koneksi, "SELECT * FROM tb_karyawan LEFT JOIN tb_jabatan ON tb_karyawan.id_jabatan=tb_jabatan.id_jabatan WHERE id_karyawan='$userID'");
                                    $row = mysqli_fetch_array($jabatan); 
                                  ?>
                                ...
                                <td>
                                    <a href="edit_karyawan.php?id_karyawan=<?php echo $row['id_karyawan']; ?>">
                                        <button type="button" class="btn btn-success" value="Edit"><i class="fa fa-edit"></i></button></a> | 
                                    <a href="delete.php?id_karyawan=<?php echo $row['id_karyawan']; ?>">
