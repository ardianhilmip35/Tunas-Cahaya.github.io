<?php
	...
	if(!isset($_SESSION['id_karyawan'])) {
        ...
        if (isset($_POST['tambah'])) {
            ...
            $Alamat = $_POST['alamat'];
            $query = "INSERT INTO tb_katalog VALUES ('$IDKatalog', '$NamaBangunan', '$Kategori', '$Gambar[0]','$Deskripsi', '$Alamat')";
						...
						<div class="row" style="width: 50%; margin-left: 20%; margin-top: 3%;">
							<div class="col-sm-6" style="padding-bottom:40px;">
								<div class="card-style" style="background-color: #1E3163; width:310%; height: 100%;">
									<div class="card-body">
									<h5 style="color: #fff;"><b>Tambah Katalog</b></h5>
									</div>
								</div>
							</div>
						</div>
						<div class="row" style="width: 50%; margin-left: 20%; ">
							<div class="col-sm-6" style="padding-bottom:40px;">
								<div class="card-style" style="background-color: #B2DFFB; height: 515px; width:310%">
									<div class="card-body">
									<?php
										$auto = mysqli_query($koneksi, "select max(id_katalog) as max_code from tb_katalog");
									...
									?>
                                        ...
                                        <form action="tambah_katalog.php" method="POST" enctype="multipart/form-data">
										<p>
										...
										<select name="Kategori"  style="margin-left: 50px; width: 70%;">
                                         ...
                                         <p>
                                             ...
                                             <input type="file" name="gambar[]" placeholder="Gambar" style="margin-left: 50px; width: 67%;"/>
                                         </p>
                                         <p>
											 ...
											 <input type="text" name="deskripsi" style="margin-left: 50px; width: 70%;"></input>
                                         </p>

                                        <a href="#" style="text-decoration: none; color: black;">
                                            <button type="submit" value="" class="btn btn-primary" style="margin-left: 73%; background-color: #1E3163; width: 10%;  color: white;" name="tambah">
                                            <b>Tambah</b></button>
                                        </a>
