	...
	<body style="background-color:#ffffff">
		...
		<div id="wrapper">
                    ...
                    <div class="row" style="width: 50%; margin-left: 20%; margin-top: 3%;">
                        <div class="col-sm-6" style="padding-bottom:40px;">
                            <div class="card-style" style="background-color: #1E3163; width:310%; height: 100%;">
                                <div class="card-body">
                                <h5 style="color: #fff;"><b>Data Katalog</b></h5>
                                </div>
                            </div>
                        </div>
                    </div>
          ...
          <section class="content">
            <div class="button">
                  <a href="tambah_katalog.php" style="text-decoration: none;">
                      <button type="submit" value="" class="btn btn-primary" style="margin-left: 6%; margin-top: -14%; background-color: #B2DFFB; width: 10%; color: black;">
                      <b>Tambah</b></button>
                  </a>
                  <a href="cetak.php" style="text-decoration: none;">
                    ...
                    <!-- <div class="card-body" > -->
                      <table class="table table-bordered" width="100" cellspacing="0" border="1">
                            <tr align="center" style="background-color: #1E3163; color: white;">
                                ...
                                <th width="450px;" height="40px;">Aksi</th>
                            </tr>
                            <?php
                              //Pagination
                            include '../koneksi.php';
                            $batas = 1;
                            $banyakData = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tb_katalog"));
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="edit_katalog.php?id_katalog=<?php echo $row['id_katalog']; ?>">
                                        <button type="button" class="btn btn-success" value="Edit"><i class="fa fa-edit"></i></button></a> | 
                                    <a href="hapus.php?id_katalog=<?php echo $row['id_katalog']; ?>">
                      ...
                      <nav aria-label="Page navigation example">
                        <ul class="pagination" style="justify-content: center;">
                          ...
                          <?php } else { ?>
                            <li class="page-item">
                              <a class="page-link" href="?halaman=<?php echo $halamanAktif + 1; ?>">Next</i></a>
                            </li>
                          <?php } ?>
